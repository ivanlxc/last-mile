...
const en = {
  ...
  satelliteTerrain: "Satellite-style terrain · not live imagery",
  satelliteControls: "Drag to pan · scroll to zoom",
  terrainUnavailable:
    "Terrain image unavailable · public routes remain available",
  mapNavigation: "Map navigation",
  zoomIn: "Zoom in on map",
  zoomOut: "Zoom out of map",
...
const zh: typeof en = {
  ...
  satelliteTerrain: "卫星风格地形 · 非实时影像",
  satelliteControls: "拖动平移 · 滚轮缩放",
  terrainUnavailable: "地形影像暂不可用 · 公开路线仍可查看",
  mapNavigation: "地图视野控制",
  zoomIn: "放大地图",
  zoomOut: "缩小地图",
  resetMap: "复位地图视野",
  locations: "查看地点",
