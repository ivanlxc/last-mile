...
export const campaign = {
  ...
  briefing: [
    "临时停火后的傍晚，萨赫尔河谷的通信仍断断续续。曙光接收站在河对岸等待，你需要带领车队穿过三个决策现场，把每个人送到那里。",
    "车上是二十名平民。有人带着家里的钥匙，有人只带了证件。你可以自由查看地图、阅读情报和讨论，没有总时限。任务分别记录实际游玩与剧情用时。调查和行驶会立即完成，无需按剧情时长等待。",
  ...
  tutorial: [
    {
      number: "01",
      title: "先确认自己知道什么",
      text: "向诺亚或萨米拉索取已有简报；也可以安排新的调查。每人每关最多上报 3 条，确认调查后立即打开报告。",
    },
    {
      number: "02",
      title: "给 AI 看什么，由你决定",
      text: "每关最多上传 5 张情报卡。AI 不会自动看到其他卡片、任务用时或资源余量；自由输入会被标记为你的未核实陈述。",
    },
    {
      number: "03",
      title: "行动，也意味着放下问题",
      text: "调查与路线会推进剧情时间，但不需要实际等待。调查消耗整局共享资源，已使用的次数不会在下一关恢复。",
    },
    {
      number: "04",
      title: "结束后，重新看见你的决定",
